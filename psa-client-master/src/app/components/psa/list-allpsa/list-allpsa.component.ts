...
@Component({
    selector: 'app-list-allpsa',
    templateUrl: './list-allpsa.component.html',
    styleUrls: ['./list-allpsa.component.scss'],
})
export class ListAllPsaComponent implements OnInit {
    ...
    async presentModal() {
        const modal = await this.modalController.create({
            component: AllPpeFilterComponent,
            componentProps: {
    ...
    async getPsas() {
        ...
        this.loadingController.create({
            ...
            loading = res;
            loading.present();
            this.psaService.getPsasCompany().then(data => {
                this.ppes = data['ppes'];              
